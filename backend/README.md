...
- Returns: An object with a string key, categories, that contains an object of id: category_string key:value pairs.
```
{
  "categories": [
    {
...
DELETE `/questions/?id=<question id>`
- Delete question from the questions list.
- Request Arguments: Question Id
- Returns: success if deleted and shows the deleted id.
Example Response 
`
{
  "deleted": "22",
...
- Returns: true if successfully created along with id.
...
POST `/searchQuestions?q=<search string>`
- Searches for the questions
- Request Arguments: search_data
...
- Request Arguments: Category Id and optional Page Number.
- Returns: List of questions, number of total questions, current category and categories.
